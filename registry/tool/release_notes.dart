...
///
/// ```
/// dart run registry/tool/release_notes.dart <tag> <file>
/// ```
///
...
/// read out of the tag grammar, which lives in registry/tool/release_versions.dart and is checked there; a
/// `sed` in a `run:` block would be a second reading of the same grammar that no check can reach.
/// This one is driven by registry/test/checks/release_test.dart over a scripted git.
///
