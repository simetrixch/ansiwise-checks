...
///
/// **What a copy costs.** Two copies drift, in both directions and unnoticed. One holds the walk
/// that finds a repository rather than a package — without that walk a gate prints "every check
/// green" while a second package's files go unanalysed — and the other does not. One carries an
/// example naming a repository it does not belong to. A repair landing in one copy and not the
/// other is exactly the danger, and nothing but this reports it.
///
