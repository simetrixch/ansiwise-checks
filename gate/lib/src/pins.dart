/// The one toolchain the checks of every repository of this family are true against.
///
...
///
/// The pin names a requirement, not an installation: version_guard.dart beside this file reads the
/// SDK the gate is running on and refuses the run where the two differ, naming what was found and
/// what was expected.
library;
