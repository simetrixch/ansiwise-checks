...
/// this family. What is here besides it is THE OTHER HALF, and this is where it is driven:
...
/// compares anything to. So [undeclaredSuites] asks, for every package of the
...
DartPackage _plantedPackage({bool declaration = false, List<String> checks = const <String>[]}) {
  final Directory scratch = Directory.systemTemp.createTempSync('gate-declared-');
